...
for (let i = 0; 1 < fila.length; i++) {
  if (fila[i].prioridade !== "normal"){
    indiceProximoCliente = i;
    break;
  }
}
const proximoCliente = fila.splice(indiceProximoCliente, 1)[0];
const informacoesCliente = `(Nome: ${proximoCliente.nomeCompleto}) (CPF: ${proximoCliente.cpf}) (Prioridade: ${proximoCliente.prioridade}) (Tipo de Plano: ${proximoCliente.tipoPlano})`;
